...
class KulikovDRunFuncTestsSEQ : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(KulikovDRunFuncTestsSEQ, MatmulFromPic) {
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<NesterovATestTaskALL, InType>(kTestParam, PPC_SETTINGS_example_threads),
                   ...
                   ppc::util::AddFuncTask<KulikovDMultMatrCrsSEQ, InType>(kTestParam, PPC_SETTINGS_example_threads),
...
const auto kPerfTestName = KulikovDRunFuncTestsSEQ::PrintFuncTestName<KulikovDRunFuncTestsSEQ>;

INSTANTIATE_TEST_SUITE_P(PicMatrixTests, KulikovDRunFuncTestsSEQ, kGtestValues, kPerfTestName);
